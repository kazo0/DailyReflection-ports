...
claude mcp add --scope user --transport stdio uno-app -- dotnet dnx -y uno.devserver --mcp-app --solution-dir /dailyreflection || true
...
MCP_SERVERS='{
  "mcpServers": {
    ...
    "uno-app": {
      "type": "stdio",
      "command": "dotnet",
      "args": ["dnx", "-y", "--prerelease", "uno.devserver", "--mcp-app", "--solution-dir", "/dailyreflection"]
    }
  }
}'
